<x-admin.layouts.main>
    ...
    >
        <!-- ====== Chart One Start -->
        @include("admin.home.partials.chart-01")
        <!-- ====== Chart One End -->

        <!-- ====== Chart Two Start -->
        @include("admin.home.partials.chart-02")
        <!-- ====== Chart Two End -->

        <!-- ====== Chart Three Start -->
        @include("admin.home.partials.chart-03")
        <!-- ====== Chart Three End -->

        <!-- ====== Map One Start -->
        @include("admin.home.partials.map-01")
        <!-- ====== Map One End -->

        <!-- ====== Table One Start -->
        <div class="col-span-12 xl:col-span-8">
            @include("admin.home.partials.table-01")
        </div>
        <!-- ====== Table One End -->
        ...
        >
            ...
            <div>
                ...
                >
                    <div class="relative h-14 w-14 rounded-full">
                        <img src="{{ asset('admin/images/user/user-05.png') }}" alt="User"/>
                        <span
