@props(['title' => 'sirvan', 'number', 'cols' => 2, "link" => '#'])
<div class="bg-white col-span-{{ $cols }} shadow-md p-3">
            <div class="flex flex-col items-center">
                ...
                <a href="{{ $link }}" class="text-gray-700 hover:text-orange-500 mt-1">{{ $title }}</a>
                @if($number ?? false)
                    <p class="text-xs mt-1">({{ $number }})</p>
                @endif
            </div>
        </div>
