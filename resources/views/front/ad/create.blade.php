            ...
            <div class="flex flex-col lg:flex-row lg:gap-3">
                <section class="order-2 lg:order-1 flex-1">
                    <div class="bg-white shadow-md rounded-md p-3 mt-3 space-y-6">
                        ...
                        <x-front.forms.input-modern name="title" title="عنوان آگهی" placeholder="عنوان آگهی را وارد کنید"/>


                        <x-front.forms.category-picker/>

                        <x-front.forms.location-picker/>
                        ...
                        <x-front.forms.input-modern name="price" title="قیمت"/>
                        ...
                        <div class="lg:hidden">
                            ...
                            <button type="submit" class="bg-blue-500 text-white py-2 px-4 mt-3 rounded-md w-full">ثبت
                                آگهی
                            </button>
                        </div>
                ...
                <section class="order-1 flex-1">
                    ...
                    <div class="hidden lg:block mt-3">
                        ...
                        <div class="flex justify-end">
                            <button class="bg-blue-500 text-white py-2 px-4 rounded-md mt-4">ثبت
                                آگهی
                            </button>
                        </div>
                    </div>
